    ...
    if (body.type === "REPLY_NOTIFICATION") {
      ...
      const htmlReply = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            ...
            <a href="https://rizqikevin.my.id/chat" style="${buttonStyle}">Buka Chat Room</a>
          </div>
          <div style="${footerStyle}">
            Sent by Rizqi Kevin Portfolio System • www.rizqikevin.my.id • Serang, Indonesia
          </div>
        </div>
      `;

      await transporter.sendMail({
        from: `"Rizqi Kevin" <${process.env.NODEMAILER_EMAIL}>`,
        to: targetEmail,
      ...
      const htmlNewChat = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            <p style="font-size: 16px; margin-top: 0;">Hi Kevin,</p>
            ...
            <a href="https://rizqikevin.my.id/chat" style="${buttonStyle}">Balas Sekarang</a>
          </div>
          <div style="${footerStyle}">
